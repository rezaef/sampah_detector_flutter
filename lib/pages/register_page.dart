...
class _RegisterPageState extends State<RegisterPage> with SingleTickerProviderStateMixin {
  ...
  late final Animation<double> _passwordsFadeAnimation;
  late final Animation<Offset> _passwordsSlideAnimation;
  ...
  void initState() {
    ...
    _passwordsFadeAnimation = CurvedAnimation(
      parent: _animationController,
      curve: const Interval(0.45, 0.85, curve: Curves.easeOutCubic),
    );
    _passwordsSlideAnimation = Tween<Offset>(
      begin: const Offset(0.0, 0.08),
      end: Offset.zero,
    ).animate(CurvedAnimation(
      parent: _animationController,
                        ...
                        Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 14),
                              FadeTransition(
                                opacity: _passwordsFadeAnimation,
                                child: SlideTransition(
                                  position: _passwordsSlideAnimation,
                                  child: Column(
                                    children: [
                                      TextFormField(
